...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Big Boss Tree Felling",
    phone:     "+27 73 299 0398",
    whatsapp:  "+27 73 299 0398",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Big Boss Tree Felling — Tree felling in krugersdorp",
    description: "Big Boss Tree Felling provides professional tree felling in Krugersdorp. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Tree felling · Krugersdorp & surrounds",
    heroTitle:  "Safe tree felling — <em>from assessment to clean-up.</em>",
    heroLead:   "Big Boss Tree Felling handles tree felling, stump removal and trimming across Krugersdorp and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "Big Boss Tree Felling team at work in Krugersdorp",
      text:  "Safe, efficient tree felling — from assessment to clean-up."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Krugersdorp. Covering the wider area.",
    areasLead:  "We work across Krugersdorp, Johannesburg, Randburg and the surrounding suburbs. Emergency callouts for storm damage handled as quickly as possible.",
